<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=339933&height=180&section=header&text=GuiaNodeJS&fontSize=30&fontColor=fff&animation=twinkling&fontAlignY=35"/>
...
2. [📦 Gerenciadores de Pacotes](contents/gerenciadores-pacote.md)
3. [⚙️ Características do Node.js](contents/caracteristicas-node.md)
4. [🔄 Event Loop, Call Stack e Non-blocking I/O](contents/event-loop.md)
5. [🌎 Criando um Servidor com Node.js](contents/servidor-node.md)
6. [🛣️ Rotas e Métodos HTTP](contents/rotas-http.md)
7. [🌐 APIs REST](contents/apis-rest.md)
8. [🔢 Códigos de Status HTTP](contents/status-http.md)
9. [📨 Requisições e Respostas HTTP](contents/requisicoes-http.md)
10. [📑 Estrutura de Dados JSON](contents/json.md)
11. [📡 Criando uma API com Express](contents/api-express.md)
